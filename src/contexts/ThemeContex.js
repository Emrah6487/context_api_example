...
//iletmek istediğimiz veri için bir karayolu olacak, hangi veri state deki books verilerini
//1.context nesnesi oluşturduk
//2. başlangıç değeri verdik ve export ettik
...
//context api kullanmanın iki yolu var

/* 1. Default value this.context
- context nesnesini oluşturdur
-başlangıc değeri verdik export ettik
-ilgili componeta import ettik
-context type yardımıyla contexi ilgili componeta atatık
-this.context yardımıyla ilgili veriye ulaştık */
//console.log(myContext)

/* 
2.Provider consumer
- class componet oluşturduk veriyi state içine koyduk
- Contexte ait olun provider yardımıyla bu verimizi aldık
- bu veriyi parent componete bookcontext provider yardımıyla gönderdik
- this.props.childeren diyerek app.js de ki childiren ulaşağını söyledik
- verimizi nereye yönlenirmek istiyorsak consumer i orada yapacağız
- veriyi göndereceeğiz componenta contex import ediyoruz
-Render içeerisnde consumer ile providerden gelen veriyi yakalıyoruz.
